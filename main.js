...
var appMoviles = new Vue({
    ...
    methods: {
        ...
        if(this.marca == "" || this.modelo == "" || this.stock == 0 ){
            ...
            // llamamos  a la funcion para dar de alta al movil
            this.altaMovil()
        ...
        btnBorrar: function(id){
            Swal.fire({
                title: '¿Estás seguro de borrar el registro: '+id+" ?",
                type: 'warning',
                showCancelButton: true,
                ...
                if (result.value){
                    this.borrarMovil(id);
                    //y mostramos un mensaje sobre la eliminación -ojo ALTER TABLE 'moviles'  AUTO_INCREMENT=1
                    Swal.fire(
                        '¡Eliminado',
                        'El reistro a sido borrado.',
                        'success'
                    )
                }
            })
